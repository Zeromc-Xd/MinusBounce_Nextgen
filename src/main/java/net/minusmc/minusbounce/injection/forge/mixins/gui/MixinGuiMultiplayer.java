...
public abstract class MixinGuiMultiplayer extends MixinGuiScreen {
    ...
    public void createButtons() {
        ...
        this.buttonList.add(new GuiButton(8, this.width / 2 - 154, this.height - 28, buttonWidth2, buttonHeight, I18n.format("selectServer.refresh")));
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 154 + 78 * 3, this.height - 28, buttonWidth2, buttonHeight, I18n.format("gui.cancel")));
