...
class KnockBackEvent(var motion: Double, var full: Boolean, var power: Int, var postPower: Int, var strong: Boolean, var reduceY: Boolean, var debug: Boolean, var sprint: Boolean) : CancellableEvent()
...
class MoveInputEvent(var forward: Float, var strafe: Float, var lastForward: Float, var lastStrafe: Float, var jump: Boolean, var sneak: Boolean, var sneakMultiplier: Double) : Event() {
    val originalForward = forward
    val originalStrafe = strafe
    var movementCorrected = false
}
